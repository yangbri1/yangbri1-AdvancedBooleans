...
public class AdvancedBooleanLogic {
    ...
    public boolean returnNotBoth(boolean b1, boolean b2){
        return !(b1 & b2);  // bitwise AND operator & -- used over logical AND operator && as bitwise includes both b1 and b2
    }
    /**
    ...
    public boolean returnExclusiveOr(boolean b1, boolean b2){
        return (b1 ^ b2);   // bitwise OR operator ^ -- recall: bitwise operators compare both b1 and b2
    }
